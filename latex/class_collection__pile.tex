...
entier representant la position de la pile à rendre active dans le vector 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em a} & \-: entier representant la position de la pile à rendre active dans le vector \\
\hline
\end{DoxyParams}
